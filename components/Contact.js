        ...
        <section className=' bg-black pb-40'>
            <div className=' ml-72'>
                ...
                <div className=' mt-8 flex'>
                    ...
                    <div className=' ml-10 '>
                        <input type='text' placeholder='Name' className=' text-white border border-zinc-900 pl-2 mb-3 block w-96 h-10 bg-black' />
                        <input type='email' placeholder='Email' className=' text-white pl-2 mb-3 block w-96 h-10 border border-zinc-900 bg-black' />
                        <textarea placeholder='Message' className=' text-white pl-2 mb-3 block w-96 h-32 resize-none border border-zinc-900 bg-black'/>
