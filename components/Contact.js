            ...
            <div className=' ml-72'>
                ...
                <div className=' mt-8 flex'>
                    ...
                    <div className=' ml-10 '>
                        ...
                        <input type='email' placeholder='Email' className=' pl-2 mb-3 block w-96 h-10 border border-zinc-900 bg-black' />
                        <textarea placeholder='Message' className=' pl-2 mb-3 block w-96 h-32 resize-none border border-zinc-900 bg-black'/>
